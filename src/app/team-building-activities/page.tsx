...
import { ArrowLeft, ArrowRight, Users, CheckCircle2, Menu, X } from 'lucide-react';

export default function TeamBuildingActivitiesPage() {
      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-white to-orange-50">
        <div className="container mx-auto px-4 pt-12 pb-8 sm:pt-16 sm:pb-12">
          ...
          <div className="mt-6 sm:mt-8">
            <h1 className="text-3xl sm:text-4xl font-extrabold text-gray-900 tracking-tight">Team Building Activities</h1>
            <p className="mt-3 text-gray-600 max-w-2xl">Details, instructions, and links for Team Building Activities will be published here. Stay tuned.</p>
          </div>
        </div>
      </section>
